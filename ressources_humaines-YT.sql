...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 18 Avril 2016 à 16:55
...
CREATE TABLE IF NOT EXISTS `infopersonnels` (
  ...
  `UNIVRESITEE` varchar(255) DEFAULT NULL,
  `DEPARTEMENT` varchar(255) DEFAULT NULL,
  `DIPLOME` varchar(255) DEFAULT NULL,
  `SPECIALITEE` varchar(255) DEFAULT NULL,
...
INSERT INTO `infopersonnels` (`ID`, `SEX`, `NOMAR`, `PRENOMAR`, `DATE_NAISSANCE`, `LIEU_DE_NAISSANCE`, `SITUATION_FAMILIALE`, `SITUATION_ADMINISTRATIVE`, `DATE_RECRUTMENT`, `Date_affectation`, `ECHELLE`, `ECHELON`, `SEPCIALITE`, `UNIVRESITEE`, `DEPARTEMENT`, `DIPLOME`, `SPECIALITEE`, `type`) VALUES
(175, 'SEX', 'الاسم الشخصي', 'الاسم العائلي', 'Date de Naissance', 'Lieu de Naissance', 'Situation Famillial', 'Situation Administarive', 'Date recrutement', 'DATE AFFECTATION', NULL, 'Echellon', 'Specialitee', 'UNIVERSITE ETABLISSMENT', 'DEPARTEMENT', 'DIPLOME', 'SPECIALITEE DE DIPLOME', 'prof'),
(176, 'hh', 'hh', 'hh', 'hh', 'hh', 'hh', 'hh', 'hh', 'hh', NULL, 'hh', 'hh', 'hhh', 'hh', 'hh', 'hh', 'prof');
...
(174, 'test', 'test', 'hh', 'hh', 'hh', 'hh', 'prof'),
(173, 'hi', 'Prenom', 'Numero_Some', 'CIN', 'Grade', 'Cadre', 'prof');
